  ...
  function handleFinalCloudEncounter() {
    showMessageSequence(
      [
        ...
        { text: 'You: "Who has?"' },
        { text: 'The Cloud: "Fool! Did you not hear what I told your earlier? Rylaine has returned!"' },
        ...
        { text: 'You: "Command? You don\'t command me, Aries. But know this: Arian and Rylaine emerged together from the Void a long time ago.\n\n Rylaine killed Arian, but was mortally injured in the fight. Rylaine is dead."' },
        { text: 'The Cloud: "LIES!"' },
        { text: 'Another, stronger burst of energy strikes you. This time you stagger back, momentarily off balance.' },
        { text: 'The Cloud: "Who are you, liar?"' },
        { text: 'You: "I am Þræscype."' },
        { text: "The Cloud: \"I do not know you. So you are one of Rylaine's pups?\"" },
        ...
        { text: 'The Cloud: "LIES!!!!!"' },
        { text: 'You: "She spent her dying days leaving clues for me should I not remember who I was. Now she is gone. Now it\'s just you and I.\n\n So Aries? You seriously think your power is Alchemical? Truly?"' },
